...
| `metrics.port`                          | Port number for the metrics endpoint                                                                                        | `9999`                                                  |
| `metrics.prometheusAnnotations`         | Add Prometheus scrape annotations to the pod                                                                                | `true`                                                  |
| `metrics.podMonitor.enabled`            | Create a Prometheus Operator PodMonitor resource                                                                            | `false`                                                 |
| `metrics.podMonitor.interval`           | Prometheus scrape interval                                                                                                  | `30s`                                                   |
| `metrics.podMonitor.labels`             | Additional labels for the PodMonitor                                                                                        | `{}`                                                    |
